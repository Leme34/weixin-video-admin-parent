...
public class UsersController {
	...
	@PostMapping("login")
	@ResponseBody
	public HttpJSONResult userLogin(String username, String password,
									HttpServletRequest request, HttpServletResponse response) {
		
		// TODO 模拟登陆
		if (StringUtils.isBlank(username) || StringUtils.isBlank(password)) {
			return HttpJSONResult.errorMap("用户名和密码不能为空");
		...
		return HttpJSONResult.errorMsg("登陆失败，请重试...");
	}
